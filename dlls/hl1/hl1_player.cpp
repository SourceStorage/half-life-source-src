...
#include "globals.h"
#include "hl2_dll/ai_interactions.h"
...
const char* CHL1_Player::GetOverrideStepSound(const char* pszBaseStepSoundName)
{
	if (hl1_move_sounds.GetBool())
	{
		...
		char hl1step[50] = "hl1";
		strcat(hl1step, pszBaseStepSoundName);
